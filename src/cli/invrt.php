...
use App\Commands\ConfigureBackstopCommand;
...
$container->autowire(ConfigureBackstopCommand::class)->setPublic(true);
...
$app->addCommand($container->get(ConfigureBackstopCommand::class));
